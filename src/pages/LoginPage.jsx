...
function LoginPage() {
  ...
  const { singup, signin, isAuthenticated, errors: RegisterErrors } = useAuth();
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Ingreso a la plataforma</span>
              ...
              <form onSubmit={onSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.email && (<p className='text-meta-1'>Correo electrónico es requerido</p>)}
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.password && (<p className='text-meta-1'>La contraseña es requerida</p>)}
                    <span className="absolute right-4 top-4">
                ...
                <div className="mt-6 text-center">
                  <p className="font-medium">
                    ¿No tienes cuenta?
                    <Link to={'/register'} className="text-primary px-1">Registrate</Link>
                  </p>
                </div>
              </form>
            </div>
