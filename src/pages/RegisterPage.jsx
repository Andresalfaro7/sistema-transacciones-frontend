...
import LoginImage from '../assets/images/svg/LoginImage';
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="font-medium 2xl:px-20">
                Gestiona tu flujo de efectivo de la mejor manera
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Registrarse en la plataforma</span>
              <h2 className="mb-9 text-2xl font-bold text-black sm:text-title-xl2">
                Registrarse
              </h2>
              {RegisterErrors.map((error, i) => (
                <div className='bg-meta-1 p-2 text-white' key={i}>{error}</div>
              ))}
              <form onSubmit={onSubmit}>
                <div className="mb-4">
                  <label htmlFor='names' className="mb-2.5 block font-medium text-black">Nombres</label>
                  <div className="relative">
                    <input
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:focus:border-primary dark:border-form-strokedark"
                      type="text"
                      id='names'
                      placeholder="Ingresa tus nombres"
                      {...register("names", { required: true })}
                    />
                    {errors.names && (<p className='text-meta-1'>Nombres requeridos</p>)}
                ...
                <div className="mb-4">
                  <label htmlFor='lastnames' className="mb-2.5 block font-medium text-black">Apellidos</label>
                  <div className="relative">
                    <input
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:focus:border-primary dark:border-form-strokedark"
                      type="text"
                    ...
                    />
                    {errors.lastnames && (<p className='text-meta-1'>Apellidos requeridos</p>)}
                    <span className="absolute right-4 top-4">
                      <svg className="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5">
                          <path d="M11.0008 9.52185C13.5445 9.52185 15.607 7.5281 15.607 5.0531C15.607 2.5781 13.5445 0.584351 11.0008 0.584351C8.45703 0.584351 6.39453 2.5781 6.39453 5.0531C6.39453 7.5281 8.45703 9.52185 11.0008 9.52185ZM11.0008 2.1656C12.6852 2.1656 14.0602 3.47185 14.0602 5.08748C14.0602 6.7031 12.6852 8.00935 11.0008 8.00935C9.31641 8.00935 7.94141 6.7031 7.94141 5.08748C7.94141 3.47185 9.31641 2.1656 11.0008 2.1656Z" fill="" />
                ...
                <div className="mb-4">
                  <label htmlFor='email' className="mb-2.5 block font-medium text-black">Correo electrónico</label>
                  <div className="relative">
                    <input
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:focus:border-primary dark:border-form-strokedark"
                      type="email"
                    ...
                    />
                    {errors.email && (<p className='text-meta-1'>Correo electrónico requerido</p>)}
                    <span className="absolute right-4 top-4">
                ...
                <div className="mb-4">
                  <label htmlFor='password' className="mb-2.5 block font-medium text-black">Contraseña</label>
                  <div className="relative">
                    <input
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:focus:border-primary dark:border-form-strokedark"
                      type="password"
                    ...
                    />
                    {errors.password && (<p className='text-meta-1'>Contraseña requerida</p>)}
                    <span className="absolute right-4 top-4">
                      <svg className="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.5">
                ...
                <div className="mt-6 text-center">
                  <p className="font-medium">
                    ...
                    <Link to={'/login'} className="text-primary px-1"> Iniciar sesión</Link>
                  </p>
                </div>
              </form>
            </div>
